...
GapicOp = Google::Gapic::Operation
...
class MockLroClient
  ...
  def get_operation request, options = nil
    ...
    Google::Gapic::Operation.new grpc_op, self
  end
...
describe Google::Gapic::Operation do
  ...
  describe "method `cancel`" do
    it "should call the clients cancel_operation" do
      ...
      cancel_method = proc do |name:, options:|
        ...
        _(options).must_be_kind_of Google::Gapic::ApiCall::Options
        called = true
      end
