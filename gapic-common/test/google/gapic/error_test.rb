...
describe Google::Gapic::GapicError do
  describe "without cause" do
    it "presents GRPC::BadStatus values" do
      error = Google::Gapic::GapicError.new "no cause"

      _(error).must_be_kind_of Google::Gapic::GapicError
  ...
  describe "#from_error" do
    it "identifies CanceledError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(1, "cancelled")
      _(mapped_error).must_equal Google::Gapic::CanceledError
    end

    it "identifies UnknownError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(2, "unknown")
      _(mapped_error).must_equal Google::Gapic::UnknownError
    end

    it "identifies InvalidArgumentError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(3, "invalid")
      _(mapped_error).must_equal Google::Gapic::InvalidArgumentError
    end

    it "identifies DeadlineExceededError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(4, "exceeded")
      _(mapped_error).must_equal Google::Gapic::DeadlineExceededError
    end

    it "identifies NotFoundError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(5, "not found")
      _(mapped_error).must_equal Google::Gapic::NotFoundError
    end

    it "identifies AlreadyExistsError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(6, "exists")
      _(mapped_error).must_equal Google::Gapic::AlreadyExistsError
    end

    it "identifies PermissionDeniedError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(7, "denied")
      _(mapped_error).must_equal Google::Gapic::PermissionDeniedError
    end

    it "identifies ResourceExhaustedError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(8, "exhausted")
      _(mapped_error).must_equal Google::Gapic::ResourceExhaustedError
    end

    it "identifies FailedPreconditionError" do
      mapped_error =
        Google::Gapic.from_error GRPC::BadStatus.new(9, "precondition")
      _(mapped_error).must_equal Google::Gapic::FailedPreconditionError
    end

    it "identifies AbortedError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(10, "aborted")
      _(mapped_error).must_equal Google::Gapic::AbortedError
    end

    it "identifies OutOfRangeError" do
      mapped_error =
        Google::Gapic.from_error GRPC::BadStatus.new(11, "out of range")
      _(mapped_error).must_equal Google::Gapic::OutOfRangeError
    end

    it "identifies UnimplementedError" do
      mapped_error =
        Google::Gapic.from_error GRPC::BadStatus.new(12, "unimplemented")
      _(mapped_error).must_equal Google::Gapic::UnimplementedError
    end

    it "identifies InternalError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(13, "internal")
      _(mapped_error).must_equal Google::Gapic::InternalError
    end

    it "identifies UnavailableError" do
      mapped_error =
        Google::Gapic.from_error GRPC::BadStatus.new(14, "unavailable")
      _(mapped_error).must_equal Google::Gapic::UnavailableError
    end

    it "identifies DataLossError" do
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(15, "data loss")
      _(mapped_error).must_equal Google::Gapic::DataLossError
    end

    it "identifies UnauthenticatedError" do
      mapped_error =
        Google::Gapic.from_error GRPC::BadStatus.new(16, "unauthenticated")
      _(mapped_error).must_equal Google::Gapic::UnauthenticatedError
    end

    it "identifies unknown error" do
      # We don't know what to map this error case to
      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(0, "unknown")
      _(mapped_error).must_equal Google::Gapic::GapicError

      mapped_error = Google::Gapic.from_error GRPC::BadStatus.new(17, "unknown")
      _(mapped_error).must_equal Google::Gapic::GapicError
    end
  end
  ...
  def wrap_with_gax_error err
    ...
    klass = Google::Gapic.from_error e
