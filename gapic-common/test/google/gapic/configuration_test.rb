...
require "google/gapic/configuration"

describe Google::Gapic::Configuration do
  let(:new_config) { Google::Gapic::Configuration.new }
  let(:simple_config) do
    Google::Gapic::Configuration.new do |config|
  ...
  let(:checked_config) do
    Google::Gapic::Configuration.new do |c1|
  ...
  describe ".new" do
    it "works with no parameters" do
      config = Google::Gapic::Configuration.new

      assert Google::Gapic::Configuration === config
    ...
    it "initializes nested Google::Gapic::Configuration" do
      assert Google::Gapic::Configuration === simple_config.k1
      assert Google::Gapic::Configuration === simple_config.k1.k2
      assert Google::Gapic::Configuration === simple_config.k1.k2.k3
    end
    ...
    it "can inspect" do
      expected_inspect = "#<Google::Gapic::Configuration: {:k1=>{:k2=>{:k3=>{}}}}>"
  ...
  describe "#add_config!" do
    it "adds an empty subconfig" do
      ...
      assert Google::Gapic::Configuration === new_config.sub1
  ...
  describe "#method_missing" do
    ...
    it "checks type of an integer field and allows but warns on invalid" do
      ...
      -> () {
        checked_config.opt1_int = Google::Gapic::Configuration::DeferredValue.new { rand(10) }
    ...
    it "checks type of a symbol field and allows but warns on invalid" do
      ...
      -> () {
        checked_config.sub1.opt2_sym = Google::Gapic::Configuration::DeferredValue.new { "foo".to_sym }
    ...
    it "checks type of a boolean field and allows but warns on invalid" do
      ...
      -> () {
        checked_config.sub1.sub2.opt3_bool = Google::Gapic::Configuration::DeferredValue.new { true }
        checked_config.sub1.sub2.opt3_bool.must_equal true
      }.must_be_silent
    ...
    it "checks type of an enum field" do
      ...
      -> () {
        checked_config.sub1.sub2.opt3_enum = Google::Gapic::Configuration::DeferredValue.new { :one }
    ...
    it "checks type of an regex match field" do
      ...
      -> () {
        checked_config.sub1.sub2.opt3_regex = Google::Gapic::Configuration::DeferredValue.new { String :foo }
