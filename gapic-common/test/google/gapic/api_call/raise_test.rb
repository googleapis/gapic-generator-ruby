...
class ApiCallRaiseTest < Minitest::Test
  def test_traps_exception
    api_meth_stub = proc do |*_args|
      raise Google::Gapic::GapicError
    end

    api_call = Google::Gapic::ApiCall.new(
      api_meth_stub
    )

    assert_raises Google::Gapic::GapicError do
  ...
  def test_wraps_grpc_errors
    ...
    api_call = Google::Gapic::ApiCall.new api_meth_stub

    exc = assert_raises Google::Gapic::GapicError do
      api_call.call Object.new
    end
