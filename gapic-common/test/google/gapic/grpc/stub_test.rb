...
class GrpcStubTest < Minitest::Spec
  ...
  def test_with_channel
    ...
    Google::Gapic::Grpc::Stub.new mock, host: "service", port: "port", credentials: fake_channel
  ...
  def test_with_channel_credentials
    ...
    Google::Gapic::Grpc::Stub.new mock, host: "service", port: "port", credentials: fake_channel_creds
  ...
  def test_with_credentials
    GRPC::Core::CallCredentials.stub :new, FakeCallCredentials.method(:new) do
      GRPC::Core::ChannelCredentials.stub :new, FakeChannelCredentials.method(:new) do
        ...
        Google::Gapic::Grpc::Stub.new mock, host: "service", port: "port", credentials: FakeCredentials.new
  ...
  def test_with_proc
    GRPC::Core::CallCredentials.stub :new, FakeCallCredentials.method(:new) do
      GRPC::Core::ChannelCredentials.stub :new, FakeChannelCredentials.method(:new) do
        ...
        Google::Gapic::Grpc::Stub.new mock, host: "service", port: "port", credentials: credentials_proc
