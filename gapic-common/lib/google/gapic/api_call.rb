...
require "google/gapic/api_call/options"
...
module Google
  module Gapic
    class ApiCall
      ...
      #   )
      #   echo_call = Google::Gapic::ApiCall.new echo_stub.method :echo
      #
      ...
      def wrap_error error
        Google::Gapic.from_error(error).new "RPC failed: #{error.message}"
      end
    end
  end
end
