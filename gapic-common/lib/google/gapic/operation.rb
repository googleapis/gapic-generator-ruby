...
require "google/gapic/operation/retry_policy"
...
module Google
  module Gapic
    ...
    class Operation
      ...
      #   the options object, using keys that match the arguments for {ApiCall::Options.new}.
      #
      # @return [Google::Gapic::Operation] Since this method changes internal state, it returns itself.
      #
      ...
      #
      # @yield operation [Google::Gapic::Operation] Yields the finished Operation.
      #
