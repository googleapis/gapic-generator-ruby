...
require "google/gapic/configuration/derived"
...
module Google
  module Gapic
    ...
    #
    #   config = Google::Gapic::Configuration.new do |c|
    #     c.add_field! :opt1, 10
    ...
    #
    #   config.sub              #=> <Google::Gapic::Configuration>
    #
    ...
    class Configuration < BasicObject
      ...
      def to_s!
        ...
        "<Google::Gapic::Configuration: #{elems.join ' '}>"
      end
      ...
      #
      def inspect
        "#<Google::Gapic::Configuration: #{to_h!}>"
      end
