...
tool "generators" do
  ...
  def prepare_changes
    ...
    update_changelog_file "gapic-generator/CHANGELOG.md", @base_messages, @new_version, @new_date
    update_changelog_file "gapic-generator-ads/CHANGELOG.md", @ads_messages, @new_version, @new_date
    update_changelog_file "gapic-generator-cloud/CHANGELOG.md", @cloud_messages, @new_version, @new_date
    update_bundles
  end
