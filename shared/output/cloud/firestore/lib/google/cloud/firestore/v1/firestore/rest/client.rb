          ...
          module Rest
            ...
            class Client
              ...
              def get_document request, options = nil
                ...
                @firestore_stub.get_document request, options do |result, response|
              ...
              def list_documents request, options = nil
                ...
                @firestore_stub.list_documents request, options do |result, response|
              ...
              def update_document request, options = nil
                ...
                @firestore_stub.update_document request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Faraday::Error => e
              ...
              def delete_document request, options = nil
                ...
                @firestore_stub.delete_document request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Faraday::Error => e
              ...
              def batch_get_documents request, options = nil
                ...
                Gapic::Rest::ServerStream.new(
                  Gapic::Rest::ThreadedFiberEnumerator.new do
                    @firestore_stub.batch_get_documents request, options do |req|
              ...
              def begin_transaction request, options = nil
                ...
                @firestore_stub.begin_transaction request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Faraday::Error => e
              ...
              def commit request, options = nil
                ...
                @firestore_stub.commit request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Faraday::Error => e
              ...
              def rollback request, options = nil
                ...
                @firestore_stub.rollback request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Faraday::Error => e
              ...
              def run_query request, options = nil
                ...
                Gapic::Rest::ServerStream.new(
                  Gapic::Rest::ThreadedFiberEnumerator.new do
                    @firestore_stub.run_query request, options do |req|
                      req.options.on_data = Proc.new do |chunk, overall_received_bytes|
                        Fiber.yield chunk
                      end
                    end
              ...
              def partition_query request, options = nil
                ...
                @firestore_stub.partition_query request, options do |result, response|
              ...
              def list_collection_ids request, options = nil
                ...
                @firestore_stub.list_collection_ids request, options do |result, response|
              ...
              def batch_write request, options = nil
                ...
                @firestore_stub.batch_write request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Faraday::Error => e
              ...
              def create_document request, options = nil
                ...
                @firestore_stub.create_document request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Faraday::Error => e
