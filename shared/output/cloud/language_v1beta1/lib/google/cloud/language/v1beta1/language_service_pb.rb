...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/language/v1beta1/language_service.proto", :syntax => :proto3) do
    ...
    add_message "google.cloud.language.v1beta1.Sentence" do
      ...
      optional :sentiment, :message, 2, "google.cloud.language.v1beta1.Sentiment"
    end
    ...
    add_message "google.cloud.language.v1beta1.PartOfSpeech" do
      ...
      optional :aspect, :enum, 2, "google.cloud.language.v1beta1.PartOfSpeech.Aspect"
      optional :case, :enum, 3, "google.cloud.language.v1beta1.PartOfSpeech.Case"
      optional :form, :enum, 4, "google.cloud.language.v1beta1.PartOfSpeech.Form"
      optional :gender, :enum, 5, "google.cloud.language.v1beta1.PartOfSpeech.Gender"
      optional :mood, :enum, 6, "google.cloud.language.v1beta1.PartOfSpeech.Mood"
      optional :number, :enum, 7, "google.cloud.language.v1beta1.PartOfSpeech.Number"
      optional :person, :enum, 8, "google.cloud.language.v1beta1.PartOfSpeech.Person"
      optional :proper, :enum, 9, "google.cloud.language.v1beta1.PartOfSpeech.Proper"
      optional :reciprocity, :enum, 10, "google.cloud.language.v1beta1.PartOfSpeech.Reciprocity"
      optional :tense, :enum, 11, "google.cloud.language.v1beta1.PartOfSpeech.Tense"
      optional :voice, :enum, 12, "google.cloud.language.v1beta1.PartOfSpeech.Voice"
    end
    ...
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Aspect" do
      value :ASPECT_UNKNOWN, 0
      value :PERFECTIVE, 1
      value :IMPERFECTIVE, 2
      value :PROGRESSIVE, 3
    end
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Case" do
    ...
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Form" do
    ...
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Gender" do
      value :GENDER_UNKNOWN, 0
      value :FEMININE, 1
      value :MASCULINE, 2
      value :NEUTER, 3
    end
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Mood" do
    ...
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Number" do
      value :NUMBER_UNKNOWN, 0
      value :SINGULAR, 1
      value :PLURAL, 2
      value :DUAL, 3
    end
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Person" do
    ...
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Proper" do
      value :PROPER_UNKNOWN, 0
      value :PROPER, 1
      value :NOT_PROPER, 2
    end
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Reciprocity" do
      value :RECIPROCITY_UNKNOWN, 0
      value :RECIPROCAL, 1
      value :NON_RECIPROCAL, 2
    end
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Tense" do
    ...
    add_enum "google.cloud.language.v1beta1.PartOfSpeech.Voice" do
    ...
    add_message "google.cloud.language.v1beta1.EntityMention" do
      optional :text, :message, 1, "google.cloud.language.v1beta1.TextSpan"
      optional :type, :enum, 2, "google.cloud.language.v1beta1.EntityMention.Type"
    end
    add_enum "google.cloud.language.v1beta1.EntityMention.Type" do
    ...
    add_message "google.cloud.language.v1beta1.AnalyzeSentimentResponse" do
      ...
      repeated :sentences, :message, 3, "google.cloud.language.v1beta1.Sentence"
    end
    ...
    add_message "google.cloud.language.v1beta1.AnalyzeSyntaxRequest" do
      optional :document, :message, 1, "google.cloud.language.v1beta1.Document"
      optional :encoding_type, :enum, 2, "google.cloud.language.v1beta1.EncodingType"
    end
    add_message "google.cloud.language.v1beta1.AnalyzeSyntaxResponse" do
