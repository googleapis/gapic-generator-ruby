...
class Google::Cloud::Speech::V1::Speech::OperationsTest < Minitest::Test
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, @mock_stub do
      ...
      response = client.list_operations(Google::Longrunning::ListOperationsRequest.new(name: name, filter: filter, page_size: page_size, page_token: page_token), @options, &@operation_callback)
      assert_equal @response, response
      ...
      response = client.list_operations request = Google::Longrunning::ListOperationsRequest.new name: name, filter: filter, page_size: page_size, page_token: page_token, options = @options, &@operation_callback
      assert_equal @response, response
  ...
  def test_get_operation
    ...
    Gapic::ServiceStub.stub :new, @mock_stub do
      ...
      # Call method with options (positional / protobuf type)
      response = client.get_operation(Google::Longrunning::GetOperationRequest.new(name: name), @options, &@operation_callback)
      assert_equal @response, response
      ...
      # Call method with options (named / protobuf type)
      response = client.get_operation request = Google::Longrunning::GetOperationRequest.new name: name, options = @options, &@operation_callback
      assert_equal @response, response
  ...
  def test_delete_operation
    ...
    Gapic::ServiceStub.stub :new, @mock_stub do
      ...
      # Call method with options (positional / protobuf type)
      response = client.delete_operation(Google::Longrunning::DeleteOperationRequest.new(name: name), @options, &@operation_callback)
      assert_equal @response, response
      ...
      # Call method with options (named / protobuf type)
      response = client.delete_operation request = Google::Longrunning::DeleteOperationRequest.new name: name, options = @options, &@operation_callback
      assert_equal @response, response
  ...
  def test_cancel_operation
    ...
    Gapic::ServiceStub.stub :new, @mock_stub do
      ...
      # Call method with options (positional / protobuf type)
      response = client.cancel_operation(Google::Longrunning::CancelOperationRequest.new(name: name), @options, &@operation_callback)
      assert_equal @response, response
      ...
      # Call method with options (named / protobuf type)
      response = client.cancel_operation request = Google::Longrunning::CancelOperationRequest.new name: name, options = @options, &@operation_callback
      assert_equal @response, response
