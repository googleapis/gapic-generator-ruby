          ...
          module Rest
            ...
            class ServiceStub
              ...
              def batch_annotate_images request_pb, options = nil
                ...
                verb, uri, query_string_params, body = transcode_batch_annotate_images_request request_pb
              ...
              def batch_annotate_files request_pb, options = nil
                ...
                verb, uri, query_string_params, body = transcode_batch_annotate_files_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split("=", 2) }
                                      else
                                        {}
              ...
              def async_batch_annotate_images request_pb, options = nil
                ...
                verb, uri, query_string_params, body = transcode_async_batch_annotate_images_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split("=", 2) }
                                      else
                                        {}
              ...
              def async_batch_annotate_files request_pb, options = nil
                ...
                verb, uri, query_string_params, body = transcode_async_batch_annotate_files_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split("=", 2) }
                                      else
                                        {}
              ...
              def transcode_batch_annotate_images_request request_pb
              ...
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def transcode_batch_annotate_files_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
              ...
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def transcode_async_batch_annotate_images_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
              ...
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def transcode_async_batch_annotate_files_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
