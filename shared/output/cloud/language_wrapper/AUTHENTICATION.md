...
The recommended way to authenticate to the google-cloud-language library is to use
...
The google-cloud-language library provides several mechanisms to configure your system.
