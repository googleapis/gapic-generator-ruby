    ...
    module V1alpha3
      module Testing
        ...
        class Client
          ...
          #
          # @yield [response, operation] Access the result along with the RPC operation
          # @yieldparam response [Gapic::PagedEnumerable<Google::Showcase::V1alpha3::Session>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          #
          # @return [Gapic::PagedEnumerable<Google::Showcase::V1alpha3::Session>]
          #
          # @raise [Gapic::GapicError] if the RPC is aborted.
          #
          # @example
          ...
          #
          # @yield [response, operation] Access the result along with the RPC operation
          # @yieldparam response [Gapic::PagedEnumerable<Google::Showcase::V1alpha3::Test>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          #
          # @return [Gapic::PagedEnumerable<Google::Showcase::V1alpha3::Test>]
          #
          # @raise [Gapic::GapicError] if the RPC is aborted.
          #
          # @example
