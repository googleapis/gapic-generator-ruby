...
describe Google::Showcase::V1alpha3::Testing::Client do
  describe "create_session" do
    ...
    it "invokes create_session without error" do
      ...
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Showcase::V1alpha3::Session

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of Google::Showcase::V1alpha3::CreateSessionRequest, request
        assert_equal Gapic::Protobuf.coerce(session, to: Google::Showcase::V1alpha3::Session), request.session
  ...
  describe "list_sessions" do
    ...
    it "invokes list_sessions without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Showcase::V1alpha3::ListSessionsResponse
  ...
  describe "report_session" do
    ...
    it "invokes report_session without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Showcase::V1alpha3::ReportSessionResponse
  ...
  describe "list_tests" do
    ...
    it "invokes list_tests without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Showcase::V1alpha3::ListTestsResponse
  ...
  describe "verify_test" do
    ...
    it "invokes verify_test without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Showcase::V1alpha3::VerifyTestResponse
