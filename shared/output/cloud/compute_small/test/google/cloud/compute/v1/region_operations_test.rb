...
class ::Google::Cloud::Compute::V1::RegionOperations::ClientTest < Minitest::Test
  ...
  def test_get
    ...
    get_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Compute::V1::GetRegionOperationRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_client_stub do
      ...
      # Use hash object
      client.get({ operation: operation, project: project, region: region }) do |response, operation|
      ...
      # Use protobuf object
      client.get ::Google::Cloud::Compute::V1::GetRegionOperationRequest.new(operation: operation, project: project, region: region) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.get({ operation: operation, project: project, region: region }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.get ::Google::Cloud::Compute::V1::GetRegionOperationRequest.new(operation: operation, project: project, region: region), grpc_options do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::RegionOperations::Client::Configuration, config
  end
end
