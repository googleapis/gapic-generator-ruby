  ...
  module Cloud
    module Compute
      module V1
        module Addresses
          ##
          # Client for the Addresses service.
          #
          # Services
          #
          # The Addresses API.
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Compute::V1::Addresses::Client::Configuration}
            ...
            ##
            # Create a new Addresses client object.
            #
            # ## Examples
            #
            # To create a new Addresses client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Compute::V1::Addresses::Client.new
            #
            # To create a new Addresses client with a custom
            # configuration:
            #
            ...
            def initialize
              ...
              @addresses_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Compute::V1::Addresses::Stub,
            ...
            #
            # @overload aggregated_list(filter: nil, include_all_scopes: nil, max_results: nil, order_by: nil, page_token: nil, project: nil)
            ...
            # @yieldparam response [::Google::Cloud::Compute::V1::AddressAggregatedList]
            ...
            def aggregated_list request, options = nil
              ...
              metadata = @config.rpcs.aggregated_list.metadata.to_h
              ...
              @addresses_stub.call_rpc :aggregated_list, request, options: options do |response, operation|
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Compute::V1::Operation]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def delete request, options = nil
              ...
              @addresses_stub.call_rpc :delete, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            def insert request, options = nil
              ...
              @addresses_stub.call_rpc :insert, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Compute::V1::AddressList]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def list request, options = nil
              ...
              @addresses_stub.call_rpc :list, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            ##
            # Configuration class for the Addresses API.
            #
            # This class represents the configuration for Addresses,
            # providing control over timeouts, retry behavior, logging, transport
            # parameters, and other low-level controls. Certain parameters can also be
            # applied individually to specific RPCs. See
            # {::Google::Cloud::Compute::V1::Addresses::Client::Configuration::Rpcs}
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for aggregated_list
