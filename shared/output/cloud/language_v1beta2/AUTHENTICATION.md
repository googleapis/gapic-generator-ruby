...
The recommended way to authenticate to the google-cloud-language-v1beta2 library is to use
...
The google-cloud-language-v1beta2 library provides several mechanisms to configure your system.
