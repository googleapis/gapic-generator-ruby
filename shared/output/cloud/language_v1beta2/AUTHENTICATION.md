...
In general, the google-cloud-language-v1beta2 library uses [Service
...
The google-cloud-language-v1beta2 library aims to make authentication
...
The environment variables that google-cloud-language-v1beta2 checks for credentials are configured on the service Credentials class (such as {Google::Cloud::Language::V1beta2::LanguageService::Credentials}):
...
connect to most services with google-cloud-language-v1beta2.
