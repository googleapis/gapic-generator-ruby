...
In general, the google-cloud-speech-v1 library uses [Service
...
The google-cloud-speech-v1 library aims to make authentication
...
The environment variables that google-cloud-speech-v1 checks for credentials are configured on the service Credentials class (such as {Google::Cloud::Speech::V1::Speech::Credentials}):
