...
class ::Google::Cloud::Speech::V1::Speech::ClientTest < Minitest::Test
  ...
  def test_recognize
    ...
    Gapic::ServiceStub.stub :new, recognize_client_stub do
      # Create client
      client_stub = ::Google::Cloud::Speech::V1::Speech::Client.new do |config|
        config.credentials = grpc_channel
      end

      # Use hash object
      client_stub.recognize({ config: config, audio: audio }) do |response, operation|
      ...
      # Use protobuf object
      client_stub.recognize ::Google::Cloud::Speech::V1::RecognizeRequest.new(config: config, audio: audio) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client_stub.recognize({ config: config, audio: audio }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client_stub.recognize(::Google::Cloud::Speech::V1::RecognizeRequest.new(config: config, audio: audio), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_long_running_recognize
    ...
    Gapic::ServiceStub.stub :new, long_running_recognize_client_stub do
      ...
      # Use hash object
      client_stub.long_running_recognize({ config: config, audio: audio, output_config: output_config }) do |response, operation|
      ...
      # Use protobuf object
      client_stub.long_running_recognize ::Google::Cloud::Speech::V1::LongRunningRecognizeRequest.new(config: config, audio: audio, output_config: output_config) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client_stub.long_running_recognize({ config: config, audio: audio, output_config: output_config }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client_stub.long_running_recognize(::Google::Cloud::Speech::V1::LongRunningRecognizeRequest.new(config: config, audio: audio, output_config: output_config), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_streaming_recognize
    ...
    Gapic::ServiceStub.stub :new, streaming_recognize_client_stub do
      ...
      client_stub.streaming_recognize enum_input do |response, operation|
      ...
      client_stub.streaming_recognize stream_input do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Speech::V1::StreamingRecognizeResponse, r
        end
      ...
      request_proto = ::Google::Cloud::Speech::V1::StreamingRecognizeRequest.new streaming_config: streaming_config
      enum_input = [request_hash, request_proto].to_enum
      client_stub.streaming_recognize enum_input, grpc_options do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Speech::V1::StreamingRecognizeResponse, r
        end
      ...
      request_proto = ::Google::Cloud::Speech::V1::StreamingRecognizeRequest.new streaming_config: streaming_config
      stream_input = Gapic::StreamInput.new
      client_stub.streaming_recognize stream_input, grpc_options do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Speech::V1::StreamingRecognizeResponse, r
        end
