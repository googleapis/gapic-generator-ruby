...
The recommended way to authenticate to the google-cloud-compute library is to use
...
The google-cloud-compute library provides several mechanisms to configure your system.
