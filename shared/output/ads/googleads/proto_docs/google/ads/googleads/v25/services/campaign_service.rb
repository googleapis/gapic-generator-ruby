  ...
  module Ads
    module GoogleAds
      module V25
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V25::Services::CampaignService::Client#mutate_campaigns CampaignService.MutateCampaigns}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaigns are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V25::Services::CampaignOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V25::Enums::ResponseContentTypeEnum::ResponseContentType]
          ...
          # @!attribute [rw] create
          #   @return [::Google::Ads::GoogleAds::V25::Resources::Campaign]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V25::Services::MutateCampaignResult>]
          ...
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V25::Services::EnableOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V25::Services::BrandCampaignAssets]
          ...
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V25::Services::EnablementResult>]
