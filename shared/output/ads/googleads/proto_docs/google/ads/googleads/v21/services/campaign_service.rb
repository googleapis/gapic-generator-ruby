  ...
  module Ads
    module GoogleAds
      module V21
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V21::Services::CampaignService::Client#mutate_campaigns CampaignService.MutateCampaigns}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaigns are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V21::Services::CampaignOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V21::Enums::ResponseContentTypeEnum::ResponseContentType]
          ...
          # @!attribute [rw] create
          #   @return [::Google::Ads::GoogleAds::V21::Resources::Campaign]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V21::Services::MutateCampaignResult>]
          ...
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V21::Services::EnableOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V21::Services::BrandCampaignAssets]
          ...
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V21::Services::EnablementResult>]
