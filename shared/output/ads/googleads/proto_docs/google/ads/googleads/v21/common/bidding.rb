    ...
    module GoogleAds
      module V21
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V21::Common::TargetCpmTargetFrequencyGoal]
          ...
          #   @return [::Google::Ads::GoogleAds::V21::Enums::TargetFrequencyTimeUnitEnum::TargetFrequencyTimeUnit]
          ...
          #   @return [::Google::Ads::GoogleAds::V21::Enums::TargetImpressionShareLocationEnum::TargetImpressionShareLocation]
          ...
          # @!attribute [rw] goal
          #   @return [::Google::Ads::GoogleAds::V21::Enums::FixedCpmGoalEnum::FixedCpmGoal]
          #     Fixed CPM bidding goal. Determines the exact bidding optimization
          #     parameters.
          # @!attribute [rw] target_frequency_info
          #   @return [::Google::Ads::GoogleAds::V21::Common::FixedCpmTargetFrequencyGoalInfo]
          #     Target frequency bidding goal details.
          class FixedCpm
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] time_unit
          #   @return [::Google::Ads::GoogleAds::V21::Enums::FixedCpmTargetFrequencyTimeUnitEnum::FixedCpmTargetFrequencyTimeUnit]
          #     Time window expressing the period over which you want to reach
          #     the specified target_count.
