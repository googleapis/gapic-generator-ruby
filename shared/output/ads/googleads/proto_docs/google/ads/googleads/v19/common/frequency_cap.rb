    ...
    module GoogleAds
      module V19
        module Common
          ...
          # @!attribute [rw] key
          #   @return [::Google::Ads::GoogleAds::V19::Common::FrequencyCapKey]
          ...
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V19::Enums::FrequencyCapLevelEnum::FrequencyCapLevel]
          ...
          #   @return [::Google::Ads::GoogleAds::V19::Enums::FrequencyCapEventTypeEnum::FrequencyCapEventType]
          #     The type of event that the cap applies to (for example, impression).
          # @!attribute [rw] time_unit
          #   @return [::Google::Ads::GoogleAds::V19::Enums::FrequencyCapTimeUnitEnum::FrequencyCapTimeUnit]
