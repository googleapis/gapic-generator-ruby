    ...
    module GoogleAds
      module V21
        module Common
          ...
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V21::Enums::FrequencyCapLevelEnum::FrequencyCapLevel]
          ...
          #   @return [::Google::Ads::GoogleAds::V21::Enums::FrequencyCapEventTypeEnum::FrequencyCapEventType]
          #     The type of event that the cap applies to (for example, impression).
          # @!attribute [rw] time_unit
          #   @return [::Google::Ads::GoogleAds::V21::Enums::FrequencyCapTimeUnitEnum::FrequencyCapTimeUnit]
