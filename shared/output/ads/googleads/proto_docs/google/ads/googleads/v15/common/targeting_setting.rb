    ...
    module GoogleAds
      module V15
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V15::Common::TargetRestriction>]
          #     The per-targeting-dimension setting to restrict the reach of your campaign
          #     or ad group.
          # @!attribute [rw] target_restriction_operations
          #   @return [::Array<::Google::Ads::GoogleAds::V15::Common::TargetRestrictionOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V15::Enums::TargetingDimensionEnum::TargetingDimension]
          ...
          #   @return [::Google::Ads::GoogleAds::V15::Common::TargetRestrictionOperation::Operator]
          #     Type of list operation to perform.
          # @!attribute [rw] value
          #   @return [::Google::Ads::GoogleAds::V15::Common::TargetRestriction]
