    ...
    module GoogleAds
      module V25
        module Common
          ...
          #     The limit applies to all keywords managed by the strategy.
          #     Mutable for portfolio bidding strategies only.
          # @!attribute [rw] target_roas_tolerance_percent_millis
          #   @return [::Integer]
          ...
          #   @return [::Google::Ads::GoogleAds::V25::Common::TargetCpmTargetFrequencyGoal]
          ...
          #   @return [::Google::Ads::GoogleAds::V25::Enums::TargetFrequencyTimeUnitEnum::TargetFrequencyTimeUnit]
          ...
          #   @return [::Google::Ads::GoogleAds::V25::Enums::TargetImpressionShareLocationEnum::TargetImpressionShareLocation]
          ...
          # @!attribute [rw] goal
          #   @return [::Google::Ads::GoogleAds::V25::Enums::FixedCpmGoalEnum::FixedCpmGoal]
          #     Fixed CPM bidding goal. Determines the exact bidding optimization
          #     parameters.
          # @!attribute [rw] target_frequency_info
          #   @return [::Google::Ads::GoogleAds::V25::Common::FixedCpmTargetFrequencyGoalInfo]
          #     Target frequency bidding goal details.
          class FixedCpm
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] time_unit
          #   @return [::Google::Ads::GoogleAds::V25::Enums::FixedCpmTargetFrequencyTimeUnitEnum::FixedCpmTargetFrequencyTimeUnit]
          #     Time window expressing the period over which you want to reach
          #     the specified target_count.
          ...
          # @!attribute [rw] target_cpc_micros
          #   @return [::Integer]
          #     Average CPC target.
          #     This target should be greater than or equal to minimum billable unit based
          #     on the currency for the account.
