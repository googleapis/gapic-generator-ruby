...
module Google
  module Ads
    module GoogleAds
      module V12
        module Services
          # Request message for {::Google::Ads::GoogleAds::V12::Services::CampaignService::Client#mutate_campaigns CampaignService.MutateCampaigns}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaigns are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V12::Services::CampaignOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V12::Enums::ResponseContentTypeEnum::ResponseContentType]
          ...
          # @!attribute [rw] create
          #   @return [::Google::Ads::GoogleAds::V12::Resources::Campaign]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V12::Services::MutateCampaignResult>]
