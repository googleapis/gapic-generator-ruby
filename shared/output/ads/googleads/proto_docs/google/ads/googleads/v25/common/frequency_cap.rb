    ...
    module GoogleAds
      module V25
        module Common
          ...
          # @!attribute [rw] key
          #   @return [::Google::Ads::GoogleAds::V25::Common::FrequencyCapKey]
          ...
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V25::Enums::FrequencyCapLevelEnum::FrequencyCapLevel]
          ...
          #   @return [::Google::Ads::GoogleAds::V25::Enums::FrequencyCapEventTypeEnum::FrequencyCapEventType]
          #     The type of event that the cap applies to (for example, impression).
          # @!attribute [rw] time_unit
          #   @return [::Google::Ads::GoogleAds::V25::Enums::FrequencyCapTimeUnitEnum::FrequencyCapTimeUnit]
