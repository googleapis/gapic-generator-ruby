...
require 'google/ads/googleads/v15/enums/response_content_type_pb'
require 'google/ads/googleads/v15/resources/campaign_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.Campaign", "google/ads/googleads/v15/resources/campaign.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignsRequest").msgclass
          CampaignOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignOperation").msgclass
          MutateCampaignsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignsResponse").msgclass
          MutateCampaignResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignResult").msgclass
        end
      end
    end
  end
