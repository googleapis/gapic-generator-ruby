...
require 'google/ads/googleads/v21/enums/response_content_type_pb'
require 'google/ads/googleads/v21/resources/campaign_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCampaignsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignsRequest").msgclass
          CampaignOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CampaignOperation").msgclass
          MutateCampaignsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignsResponse").msgclass
          MutateCampaignResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignResult").msgclass
          EnablePMaxBrandGuidelinesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.EnablePMaxBrandGuidelinesRequest").msgclass
          EnableOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.EnableOperation").msgclass
          BrandCampaignAssets = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.BrandCampaignAssets").msgclass
          EnablePMaxBrandGuidelinesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.EnablePMaxBrandGuidelinesResponse").msgclass
          EnablementResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.EnablementResult").msgclass
        end
      end
    end
  end
