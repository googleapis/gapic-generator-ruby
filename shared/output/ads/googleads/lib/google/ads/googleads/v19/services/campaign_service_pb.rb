...
require 'google/ads/googleads/v19/enums/response_content_type_pb'
require 'google/ads/googleads/v19/resources/campaign_pb'
...
module Google
  module Ads
    module GoogleAds
      module V19
        module Services
          MutateCampaignsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.MutateCampaignsRequest").msgclass
          CampaignOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.CampaignOperation").msgclass
          MutateCampaignsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.MutateCampaignsResponse").msgclass
          MutateCampaignResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.MutateCampaignResult").msgclass
          EnablePMaxBrandGuidelinesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.EnablePMaxBrandGuidelinesRequest").msgclass
          EnableOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.EnableOperation").msgclass
          BrandCampaignAssets = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.BrandCampaignAssets").msgclass
          EnablePMaxBrandGuidelinesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.EnablePMaxBrandGuidelinesResponse").msgclass
          EnablementResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.EnablementResult").msgclass
        end
      end
    end
  end
