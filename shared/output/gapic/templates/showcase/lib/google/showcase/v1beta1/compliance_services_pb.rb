    ...
    module V1beta1
      module Compliance
        ...
        class Service
          ...
          rpc :GetEnum, ::Google::Showcase::V1beta1::EnumRequest, ::Google::Showcase::V1beta1::EnumResponse
          ...
          rpc :VerifyEnum, ::Google::Showcase::V1beta1::EnumResponse, ::Google::Showcase::V1beta1::EnumResponse
        end
