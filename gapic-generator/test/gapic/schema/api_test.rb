...
class ApiTest < Minitest::Test
  API_INFO = {
      # bool parameters
      free_tier: "invalid_value", # should evaluate to default true in config
      yard_strict: "false",
      ...
      description: "The Container Analysis API is an implementation of Grafeas. It stores\\, and enables querying and retrieval of\\, critical metadata about all of your software artifacts.",
      unescaped_description: "The Container Analysis API is an implementation of Grafeas. It stores, and enables querying and retrieval of, critical metadata about all of your software artifacts.",
  ...
  def test_parse_protoc_options_literal
    literal_params = [
