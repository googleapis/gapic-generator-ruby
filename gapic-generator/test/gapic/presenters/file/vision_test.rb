...
class VisionFilePresenterTest < PresenterTest
  ...
  def test_image_annotator
    ...
    assert_equal ["Feature", "ImageSource", "Image", "FaceAnnotation", "LocationInfo", "Property", "EntityAnnotation", "LocalizedObjectAnnotation", "SafeSearchAnnotation", "LatLongRect", "ColorInfo", "DominantColorsAnnotation", "ImageProperties", "CropHint", "CropHintsAnnotation", "CropHintsParams", "WebDetectionParams", "ImageContext", "AnnotateImageRequest", "ImageAnnotationContext", "AnnotateImageResponse", "AnnotateFileResponse", "BatchAnnotateImagesRequest", "BatchAnnotateImagesResponse", "AnnotateFileRequest", "BatchAnnotateFilesRequest", "BatchAnnotateFilesResponse", "AsyncAnnotateFileRequest", "AsyncAnnotateFileResponse", "AsyncBatchAnnotateImagesRequest", "AsyncBatchAnnotateImagesResponse", "AsyncBatchAnnotateFilesRequest", "AsyncBatchAnnotateFilesResponse", "InputConfig", "OutputConfig", "GcsSource", "GcsDestination", "OperationMetadata"], fp.messages.map(&:name)
    fp.messages.each { |mp| assert_kind_of MessagePresenter, mp }
