...
class GarbageServiceTest < PresenterTest
  ...
  def test_methods
    ...
    exp_method_names = ["get_simple_garbage", "get_specific_garbage", "get_nested_garbage", "get_repeated_garbage", "get_typical_garbage", "get_complex_garbage", "get_garbage_node", "get_paged_garbage", "long_running_garbage", "client_garbage", "server_garbage", "bidi_garbage"]
