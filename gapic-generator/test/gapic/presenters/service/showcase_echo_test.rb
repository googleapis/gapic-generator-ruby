...
class ShowcaseEchoServiceTest < PresenterTest
  ...
  def test_methods
    ...
    exp_method_names = ["echo", "echo_error_details", "fail_echo_with_details", "expand", "collect", "chat", "paged_expand", "paged_expand_legacy", "paged_expand_legacy_mapped", "wait", "block"]
