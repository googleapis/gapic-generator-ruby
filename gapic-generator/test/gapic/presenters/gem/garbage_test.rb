...
class GarbageGemPresenterTest < PresenterTest
  ...
  def test_garbage
    ...
    assert_equal ["google/api/field_behavior.proto", "google/api/resource.proto", "google/protobuf/any.proto", "google/protobuf/empty.proto", "google/rpc/status.proto", "google/longrunning/operations.proto", "google/protobuf/timestamp.proto", "google/protobuf/duration.proto", "garbage/garbage.proto", "google/iam/v1/policy.proto", "google/iam/v1/iam_policy.proto", "garbage/resource_names.proto"], presenter.proto_files.map(&:name)
