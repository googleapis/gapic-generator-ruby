...
module Google
  module Cloud
    ...
    module Pubsub
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("pubsub"))
      ...
      module Publisher
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsub
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsub.const_get(version_module)::Publisher.new(*args, **kwargs)
        end
      end
      ...
      module Subscriber
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsub
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsub.const_get(version_module)::Subscriber.new(*args, **kwargs)
        end
      end
    end
  end
